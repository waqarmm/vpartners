        ...
        <div className="why-vp-icons">
          ...
          <div className="circular">
            ...
            <p>
              ...
              compromising on quality, enabling our clients to maximize value
          ...
          <div className="natural-heating">
            ...
            <p>
              ...
              clients throughout the purchasing process, from product selection
              to delivery, ensuring a seamless and hassle-free experience.
            </p>
          </div>
          <div className="health">
            ...
            <p>
              ...
              practices, sourcing materials ethically and minimizing waste in
